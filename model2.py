...
class CTCNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv = nn.Conv2d(in_channels = 1, out_channels = 12, kernel_size = 3, padding = 1)
        # 4320x1 Input and 50x1 output
        self.lstm = nn.LSTM(input_size = 4320, hidden_size = 50, num_layers = 1)
        # 50 to 11 MLP
...
for epoch in range(100):
	...
	optimizer.step()
        ...
        #pdb.set_trace(
        print str(epoch)+' : '+str(j)+' : '+ str(result.shape)
	if j%100==0:
		print result
